    ...
    return (
        <Layout>
            <div className="mx-auto max-w-2xl p-4 ">
                ...
                <p className="mb-4">At Bizzlink, we believe that every business has a story, and we are here to help you tell yours. Whether you're looking to sell your business, find the perfect investment, or simply connect with like-minded individuals, Bizlinkis your trusted partner on this exciting journey.</p>
